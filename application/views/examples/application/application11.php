...
?>
    <form action="<?= base_url('ApplicationController/saveUpdatePage11') ?>">
        <div class="row" style="margin-top: 50px">
            <div class="col-sm-12" style="margin-bottom: 10px">
                <span style="font-weight: bold;margin-right: 10px">18.</span>
        ...
        <div class="row">
            <div class="col-sm-6">
                <a href="<?= base_url('application_form/page10') ?>">
                    <button class="btn btn-primary" type="button"
                            style="left: 50%;transform: translateX(-50%);position: relative;margin-top: 80px;">Previous
                        Page
                    </button>
                </a>
            </div>
