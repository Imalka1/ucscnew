...
create table applicant(aid varchar(50),email varchar(50),name varchar(100),dob varchar(20),registered_date varchar(20),address varchar(20),telephone varchar(20),count int,marks int,constraint primary key(aid),constraint foreign key(email) references user(email));
...
insert into user values ('in1@gmail.com','900150983cd24fb0d6963f7d28e17f72','interview panel'),('in2@gmail.com','900150983cd24fb0d6963f7d28e17f72','interview panel');
