...
create table staff(sid int auto_increment,email varchar(50),name varchar(100),constraint primary key(sid),constraint foreign key(email) references user(email));
...
insert into staff (email,name) values ('in1@gmail.com','Dimuthi'),('in2@gmail.com','Dimuthi T'),('di1@gmail.com','Dimuthi Th'),('di2@gmail.com','Dimuthi Th');
